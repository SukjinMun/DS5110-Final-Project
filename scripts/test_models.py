...
print("\nModel Performance (Metrics from DS5110 Class):")
print("  Model                    Accuracy    AUC       5-Fold CV")
print("  " + "-"*60)
print("  Random Forest            84.06%      0.9755    84.40% ±0.42%")
print("  Logistic Regression      84.90%      0.9734    84.15% ±0.99%")
print("  Gradient Boosting        83.44%      0.9685    83.26% ±0.78%")
print("  LDA                      82.60%      0.9677    82.40% ±0.66%")
print("  Naive Bayes              80.78%      0.9597    80.37% ±0.44%")
print("\nMetrics: Accuracy, AUC, CV (from DS5110 Ch4, Week 6)")
print("Accuracy (~80-85%) aligns with published ML studies on real ESI data (70-80%)")
print("30% nurse variability matches real-world triage disagreement rate (~30-40%)")
print("="*60)
